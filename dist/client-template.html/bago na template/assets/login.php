                                    ...
                                    <div class="card-body">
                                        <form id="loginForm" novalidate>
                                            <div class="form-floating mb-3">
                                                <input class="form-control text-dark" id="inputEmail" type="email" placeholder="name@example.com" required />
                                            ...
                                            <div class="form-floating mb-3">
                                                <input class="form-control text-dark" id="inputPassword" type="password" placeholder="Password" required />
